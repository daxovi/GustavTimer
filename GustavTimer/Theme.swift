...
struct Theme {
    ...
    struct Fonts {
        ...
        let settingsIntervalValue = Font.custom("SpaceMono-Bold", size: 24, relativeTo: .title2)
        let settingsIntervalName = Font.custom("SpaceGrotesk-Regular", size: 24, relativeTo: .title2)
    }
